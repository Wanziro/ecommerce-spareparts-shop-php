...
function get_models($name,$vehicle_category){
    ...
    }else if($vehicle_category=='moto'){
        $sql = "SELECT * FROM vehicle_model where vehicle_category='moto' AND vehicle_mark='$name'";
    }else{
                ...
                <div class="hb-menu">
                  <nav>
                    <ul>
                      ...
                      <li class="dropdown-holder">
                        <a href="#"
                          ><i class="fa fa-truck"></i>&nbsp;Truck Parts</a
                        >
                        <?php
                        //get car marks and model
                      ...
                      <li class="dropdown-holder">
                        <a href="#"
                          ><i class="fa fa-motorcycle"></i>&nbsp;Moto Bike
                          Parts</a
                        >
                        <?php
                        //get car marks and model
                        $sql = 'SELECT * FROM vehicle_marks where vehicle_category="moto"';
                        $statement = $conn->query($sql);
