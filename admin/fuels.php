...
include"fxs.php";
function check_if_vehicle_exists($name,$category,$mark,$model){
  include"admin_protect.php";
  $sql = "SELECT * FROM fuel WHERE name='$name' AND vehicle_category='$category' AND vehicle_mark='$mark' AND vehicle_model='$model'";
...
if(isset($_POST['save'])){
  ...
  if($name != '' && $category != "" && $mark != ""){
    if(check_if_vehicle_exists($name,$category,$mark,$model)){
      $msg = "<div class='alert alert-danger'>Mark name '$name' already exists. Try to register other new vehicles.</div>";
    }else{
      $sql = "INSERT INTO fuel(name,vehicle_category,vehicle_mark,vehicle_model) VALUES (?,?,?,?)";
      $statement = $conn->prepare($sql);
      $statement->execute(array($name,$category,$mark,$model));
      $msg = '';
    }
  }else{
          ...
          <div class="row">
            ...
            if($statement->rowCount() > 0){
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">Fuels in the system</h6>
                </div>
                <div class="card-body">
                ...
                while (($row = $statement->fetch(PDO::FETCH_ASSOC)) !== false) {
                    ...
                    ?>
                        ...
                        <a href="fuels.php?delete=<?php echo $id;?>" onclick="return confirm('Do want to delete this Fuel?\nAll data related to this vehicle will also be deleted')">
                ...
                <?php
            }else{echo'<div class="col-xl-12 col-lg-12"><h2>No Fuels Found</h2><br></div>';}
            ?>  
            
            <div class="col-lg-12">
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">Register New Fuel</h6>
                </div>
                <div class="card-body">
                  <?php echo $msg;?>
                  <form method="post" action="#" enctype="multipart/form-data">
                    <div class="form-group">
                      <label>Name</label>
                      <input type="text" name="names" class="form-control" placeholder="Enter fuel name" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <select name="model" id="allModels" class="form-control" required></select>
                    </div>
