...
if(isset($_POST['edit'])){
  ...
  $oldName = get_old_vehicle_name($id);
    if(check_if_vehicle_exists($name)){
        ...
        //update the data
        $up = "UPDATE spare_parts SET name='$name',spare_part_category='$s_category',vehicle_category='$category',vehicle_mark='$mark',vehicle_model='$model',fuel='$fuel',engine='$engine',part_number='$part_number',quantity='$quantity',price='$price' WHERE id = '$id'";
