<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="../index.php">
        ...
        <div class="sidebar-brand-text mx-3">KAS Ltd</div>
      </a>
      ...
      <li class="nav-item my-0 py-0">
        <a class="nav-link" href="sold_cars.php">
          <i class="fa fa-list-alt"></i>
          <span>Sold cars</span></a>
      </li>
      <li class="nav-item my-0 py-0">
        <a class="nav-link" href="sold_trucks.php">
          <i class="fa fa-list-alt"></i>
          <span>Sold Trucks</span></a>
      </li>
      <li class="nav-item my-0 py-0">
        <a class="nav-link" href="sold_motor.php">
          <i class="fa fa-list-alt"></i>
          <span>Sold Motorcycle</span></a>
      </li>
