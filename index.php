  ...
  <div class="body-wrapper">
    ...
    <div class="rev-slider">
      <div id="rev_slider_486_1_wrapper" class="rev_slider_wrapper fullwidthbanner-container" data-alias="news-gallery36" data-source="gallery" style="margin:0px auto;background-color:#ffffff;padding:0px;margin-top:0px;margin-bottom:0px;">
        ...
        <div id="rev_slider_486_1" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.3.0.2">
          <ul>
            <!-- SLIDE  -->
            <li data-index="rs-100" data-transition="parallaxvertical" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="error-404.html" data-rotate="0" data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off" data-title="We got you covered!" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="Science says that Women are generally happier">
              <!-- MAIN IMAGE -->
              <img src="images/slider/s1.jpg" alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina />
            ...
            <li data-index="rs-200" data-transition="parallaxvertical" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="images/slider/s1.jpg" data-rotate="0" data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off" data-title="We got you covered!" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="Science says that Women are generally happier">
              ...
              <div class="tp-caption Newspaper-Subtitle   tp-resizeme" id="slide-200-layer-3" data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']" data-y="['top','top','top','top']" data-voffset="['210','210','210','210']" data-width="none" data-height="none" data-whitespace="nowrap" data-type="text" data-responsive_offset="on" data-frames='[{"from":"y:[-100%];z:0;rX:0deg;rY:0;rZ:0;sX:1;sY:1;skX:0;skY:0;","mask":"x:0px;y:0px;s:inherit;e:inherit;","speed":1500,"to":"o:1;","delay":1000,"ease":"Power3.easeInOut"},{"delay":"wait","speed":1000,"to":"auto:auto;","mask":"x:0;y:0;s:inherit;e:inherit;","ease":"Power3.easeInOut"}]' data-textAlign="['left','left','left','left']" data-paddingtop="[0,0,0,0]" data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]" style="z-index: 7; white-space: nowrap;text-transform:uppercase; color:#fff; font-family:rubik; font-size:18px; font-weight:400;">
                Engineered for better experience
              </div>

              <!-- LAYER NR. 3 -->
              <div class="tp-caption Newspaper-Subtitle   tp-resizeme" id="slide-200-layer-4" data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']" data-y="['top','top','top','top']" data-voffset="['320','320','320','290']" data-width="['800','800','700','420']" data-height="['100','100','100','120']" data-whitespace="unset" data-type="text" data-responsive_offset="on" data-frames='[{"from":"y:[-100%];z:0;rX:0deg;rY:0;rZ:0;sX:1;sY:1;skX:0;skY:0;","mask":"x:0px;y:0px;s:inherit;e:inherit;","speed":1500,"to":"o:1;","delay":1000,"ease":"Power3.easeInOut"},{"delay":"wait","speed":1000,"to":"auto:auto;","mask":"x:0;y:0;s:inherit;e:inherit;","ease":"Power3.easeInOut"}]' data-textAlign="['center','center','center','center']" data-paddingtop="[0,0,0,0]" data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]" style="z-index: 7; text-transform:capitalize; white-space: unset; color:#fff; font-family:rubik; font-size:18px; line-height:28px; font-weight:400;">
                Everything you may need for repairs and regular maintenance of your vehicle are listed in a convenient and comprehensive catalogue.
                We work hard to help each of our customers save both money and time.
              </div>
              <!-- LAYER NR. 4 -->
              <a href="#">
                <div class="tp-caption Newspaper-Button rev-btn mt-20" id="slide-200-layer-5" data-x="['center','center','center','center']" data-hoffset="['90','80','75','90']" data-y="['top','top','top','top']" data-voffset="['400','400','400','420']" data-width="none" data-height="none" data-whitespace="nowrap" data-type="button" data-responsive_offset="on" data-responsive="off" data-frames='[{"from":"y:[-100%];z:0;rX:0deg;rY:0;rZ:0;sX:1;sY:1;skX:0;skY:0;","mask":"x:0px;y:0px;","speed":1500,"to":"o:1;","delay":1000,"ease":"Power3.easeInOut"},{"delay":"wait","speed":1000,"to":"auto:auto;","mask":"x:0;y:0;","ease":"Power3.easeInOut"},{"frame":"hover","speed":"300","ease":"Power1.easeInOut","to":"o:1;rX:0;rY:0;rZ:0;z:0;","style":"c:rgba(0, 0, 0, 1.00);bg:rgba(255, 255, 255, 1.00);bc:rgba(255, 255, 255, 1.00);bw:1px 1px 1px 1px;"}]' data-textAlign="['center','center','center','center']" data-paddingtop="[12,12,12,12]" data-paddingright="[30,35,35,15]" data-paddingbottom="[12,12,12,12]" data-paddingleft="[30,35,35,15]" style="z-index: 8; white-space: nowrap; outline:none;box-shadow:none;box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;cursor:pointer; background-color:var(--primary) !important; border:0; border-radius:30px; margin-right:5px;">READ MORE </div>
              </a>
              <a href="#">
                <div class="tp-caption Newspaper-Button mt-20 rev-btn" id="slide-200-layer-6" data-x="['center','center','center','center']" data-hoffset="['-90','-80','-75','-90']" data-y="['top','top','top','top']" data-voffset="['400','400','400','420']" data-width="none" data-height="none" data-whitespace="nowrap" data-type="button" data-responsive_offset="on" data-responsive="off" data-frames='[{"from":"y:[-100%];z:0;rX:0deg;rY:0;rZ:0;sX:1;sY:1;skX:0;skY:0;","mask":"x:0px;y:0px;","speed":1500,"to":"o:1;","delay":1000,"ease":"Power3.easeInOut"},{"delay":"wait","speed":1000,"to":"auto:auto;","mask":"x:0;y:0;","ease":"Power3.easeInOut"},{"frame":"hover","speed":"300","ease":"Power1.easeInOut","to":"o:1;rX:0;rY:0;rZ:0;z:0;","style":"c:rgba(0, 0, 0, 1.00);bg:rgba(255, 255, 255, 1.00);bc:rgba(255, 255, 255, 1.00);bw:1px 1px 1px 1px;"}]' data-textAlign="['center','center','center','center']" data-paddingtop="[12,12,12,12]" data-paddingright="[30,35,35,15]" data-paddingbottom="[12,12,12,12]" data-paddingleft="[30,35,35,15]" style="z-index: 8; white-space: nowrap; outline:none;box-shadow:none;box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;cursor:pointer; border-radius:30px;">CONTACT US</div>
              </a>
            </li>
            <!-- SLIDE  -->
          </ul>
    ...
    <div id="bodyContents">
            ...
            <div class="col-lg-4 col-md-4 text-center pt-xs-30">
              <div class="li-banner">
                <div class="start-here py-3">
                  <h2>Start Here</h2>
                  <input type="hidden" value="<?php if (isset($_GET['filter'])) {
                                                echo $_GET['filter'];
                                              } else {
                                                echo 'name-az';
                                              } ?>" id="startHereFilter">
      ...
      <div class="product-area pt-30">
        <div class="container">
          <div class="text-center dark-bg text-white pt-1 pb-2 mb-50">
    ...
    <!-- product lists -->
    <div class="product-area pt-15 pb-50">
      <div class="container">
        <?php
    ...
    <!-- car renting -->
    <?php
    $qx = mysqli_query($conn2, "select * from cars_for_renting where status='enabled' order by id desc limit 10");
    if (mysqli_num_rows($qx) > 0) {
    ?>
      <div class="mb-30">
        <img src="images/banner.jpg" class="w-100" alt="car renting">
        <div class="container pt-15">
          <div class="my-row">
            <h2>Cars for renting</h2>
            <a href="car_renting.php">
              <button class='btn light-bg2 text-white'>Browse all <i class="fa fa-chevron-right"></i><i class="fa fa-chevron-right"></i></button>
            </a>
          </div>
          <div class="row">
            <div class="owl-carousel carousel_se_03_carousel owl-theme">
              <?php
              $i = 0;
              while ($rw = mysqli_fetch_assoc($qx)) {
                $image = $rw['image1'];
                $price = $rw['price'];
                $name = $rw['car_name'];
                $id = $rw['id'];
              ?>
                <div class="item">
                  <div class="col-md-12 wow fadeInUp delay-<?php echo $i ?>">
                    <div class="car-container">
                      <a href="car_details.php?id=<?php echo $id ?>">
                        <img src="images/uploads/car_renting/<?php echo $image ?>" alt="<?php echo $name ?>" class="image-responsive"></a>
                      <div class="my-row">
                        <p class="car-title"><?php echo $name ?></p>
                        <p class="light-text2"><?php echo number_format($price) . ' RWF / Day' ?></p>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div class="mt-60">
            <div class="row">
              <div class="col-md-6">
                <h3 class="dark-bg text-white p-2">AUTO Experts Rwanda Rental service</h3>
                <p class="m-0 pt-10">We offer renting service with a wide range of cars and trucks at affordable price as well as effeciency and professionalism during the service.</p>
                <p>The process is pretty easier! You have to chosse the vehicle that you wish to rent, click book now button and fill in required information then you are done!.</p>
                <div>
                  <table>
                    <tr>
                      <td>
                        <div class="services-circle">
                          <i class='fa fa-tag dark-text' style="font-size: 20px;"></i>
                      </td>
                      <td>
                        <span class="text-dark" style="font-size: 14px;font-weight:600">Easy & Competitive Prices</span>
                      </td>
                    </tr>
                    <tr>
                      <td>
                        <div class="services-circle">
                          <i class='fa fa-shield dark-text' style="font-size: 20px;"></i>
                        </div>
                      </td>
                      <td><span class="text-dark" style="font-size: 14px;font-weight:600">Breakdown Assistance</span></td>
                    </tr>
                    <tr>
                      <td>
                        <div class="services-circle">
                          <i class='fa fa-thumbs-up dark-text' style="font-size: 20px;"></i>
                        </div>
                      </td>
                      <td><span class="text-dark" style="font-size: 14px;font-weight:600">Trusted Rent Service</span></td>
                    </tr>
                    <tr>
                      <td>
                        <div class="services-circle">
                          <i class='fa fa-check dark-text' style="font-size: 20px;"></i>
                        </div>
                      </td>
                      <td><span class="text-dark" style="font-size: 14px;font-weight:600">Pay after beeing satisfied</span></td>
                    </tr>
                    <tr>
                      <td>
                        <div class="services-circle">
                          <i class='fa fa-phone dark-text' style="font-size: 20px;"></i>
                        </div>
                      </td>
                      <td><span class="text-dark" style="font-size: 14px;font-weight:600">24/7 Free Customer Support</span></td>
                    </tr>
                  </table>
                  <br><br>
                  <a href="car_renting.php">
                    <button class='btn light-bg2 text-white'>Explore More</button>
                  </a>
                </div>
              </div>
              <div class="col-md-6 wow fadeInUp">
                <img src="images/car-renting-service.jpg" alt="car rental service" class="rental-services-img">
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="call-container">
          <div class="call-container-contents px-5">
            <h1 class="text-white">Call us today for booking your next ride</h1><br>
            <h3 class="text-white light-text2"><i class="fa fa-phone"></i> +250780848761</h3>
          </div>
        </div>
